...
function NewsPreview() {
    const [newsInfo, setNewsInfo] = useState(null) //新闻数据
    const params = useParams() //获取跳转路由参数
    const auditList = ["未审核", '审核中', '已通过', '未通过'] //审核状态
    const publishList = ["未发布", '待发布', '已上线', '已下线']  //发布状态
                ...
                newsInfo && <div>
                    ...
                    >
                        <Descriptions size="small" column={3}>
                            ...
                            <Descriptions.Item label="发布状态" ><span style={{ color: "#5e17eb" }}>{publishList[newsInfo.publishState]}</span></Descriptions.Item>
